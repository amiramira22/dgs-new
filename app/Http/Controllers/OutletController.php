...
class OutletController extends Controller {
    ...
    public function index() {
        ...
        return view('outlet.index', compact('title', 'subTitle'));
    }
    ...
    public function ha_outlets() {
        ...
        return view('outlet.ha_outlets', compact('title', 'subTitle'));
    }
    ...
    public function create() {
        ...
        return view('outlet.create', compact('title', 'subTitle', 'states', 'zones', 'channels', 'subChannels', 'users'));
    }
...
//dd('test');
        return view('outlet.edit', compact('title', 'subTitle', 'outlet', 'states', 'zones', 'channels', 'subChannels', 'users', 'visit_days'));
    }
...
//        $this->outletRepository->update($id, $save);
    ...
    public function geolocalisation() {
        ...
        return view('outlet.geolocalisation', $data);
    }
