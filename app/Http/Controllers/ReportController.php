...
//****************************************************************************************************                
            // Single Date only
                ...
                foreach ($data['report_data'] as $row) {
                    ...
                    //create an array for every brand and the count at a outlet
                    $components[$row['brand_id']][$zone] = array($row['av'], $row['oos'], $row['ha']);
                    $zone_components[$row['zone']][$row['brand_id']] = array($row['av'], $row['oos'], $row['ha']);
                }
                ...
                foreach ($data['report_data'] as $row) {
                    ...
                    //create an array for every brand and the count at a outlet
                    $components[$row['brand_id']][$channel] = array($row['av'], $row['oos'], $row['ha']);
                    $channel_components[$channel][$row['brand_id']] = array($row['av'], $row['oos'], $row['ha']);
                }
                $data['components'] = $components;
        ...
        return view('report.numeric_distribution.form_report', $data);
    }
...
//dd('amira');
        ...
        //dd($data['report_data']);
        return view('report.numeric_distribution.single_date.load_av_cluster', $data);
    }
    ...
    function load_av_cluster_zones(Request $request)
    {
        ...
        return view('report.numeric_distribution.single_date.load_av_cluster_zones', $data);
    }
    ...
    function load_av_cluster_channels(Request $request)
    {
        ...
        return view('report.numeric_distribution.single_date.load_av_cluster_channels', $data);
    }
...
//create an array for every brand and the count at a outlet
            ...
            $data['date_components'] = $date_components;
            $data['dates'] = $dates;
            return view('report.numeric_distribution.multi_date.load_av_zone', $data);
        }
    }
...
//create an array for every brand and the count at a outlet
            ...
            $data['date_components'] = $date_components;
            $data['dates'] = $dates;
            return view('report.numeric_distribution.multi_date.load_av_channel', $data);
        }
    }
...
//hcm
    function extarait_pdv_dn_report(Request $request)
    {
        ...
        return view('report.numeric_distribution.extarait_pdv_dn_report', $data);
    }
...
//        $data['category_id'] = $category_id;
        ...
        $data['categories'] = $categories;
        $data['product_ids'] = $product_ids;
        return view('report.numeric_distribution.load_extarait_pdv_dn_per_category', $data);
    }
...
//                $data['sum_shelf'] = array_sum(array_values($this->reportRepository->get_total_shelf($date_type, $start_date, $end_date, $category_id, $selected_zone_ids, $selected_channel_ids)));
        ...
        return view('report.shelf_share.form_report', $data);
    }
...
//            $brand_colors[$row['brand_name']] = $row['brand_color'];
        ...
        $data['dates'] = $dates;
        $data['sum_shelf_date'] = $sum_shelf_date;
        return view('report.shelf_share.multi_date.load_shelf_zone', $data);
    }
...
//            $brand_colors[$row['brand_name']] = $row['brand_color'];
        ...
        $data['dates'] = $dates;
        $data['sum_shelf_date'] = $sum_shelf_date;
        return view('report.shelf_share.multi_date.load_shelf_channel', $data);
    }
...
//dd( $data['report_data']);
    ...
    function load_shelf_zone_pie_chart(Request $request)
    {
        ...
        return view('report.shelf_share.single_date.load_shelf_zone_pie_chart', $data);
    }
    ...
    function load_shelf_channel_pie_chart(Request $request)
    {
        ...
        return view('report.shelf_share.single_date.load_shelf_channel_pie_chart', $data);
    }
    ...
    function extarait_pdv_shelf_share_report_old(Request $request)
    {
        ...
        return view('report.shelf_share.extarait_pdv_shelf_report', $data);
    }
...
//        $data['category_id'] = $category_id;
        ...
        return view('report.shelf_share.load_extarait_pdv_shelf_per_category', $data);
    }
...
//dd($data['branding_report']);
        ...
        return view('report.pictures.branding', $data);
    }
    ...
    public function store_album(Request $request)
    {
        ...
        return view('report.pictures.store_album', $data);
    }
...
//dd($data['clusters']);
        ...
        return view('report.price_monotoring', $data);
    }
    ...
    public function load_price_monotoring_per_cluster(Request $request)
    {
        ...
        if ($start_date != '' && $cluster_id != -1) {
            ...
            if (!empty($report_data->toArray())) {
                ...
                return view('report.load_price_monotoring_per_cluster', $data);
            }
        }
    }
...
//                }
                ...
                if (($outlet->av + $outlet->oos) != 0) {
                    $av_data = number_format(($outlet->av / ($outlet->av + $outlet->oos)) * 100, 2, '.', ' ');
                ...
                $ha_data = number_format($outlet->av, 2, '.', ' ');
                ...
                $content = '<b>Outlet name:</b> ' . $outlet->name
                    ...
                    . '</br><b>' . 'oos' . ': </b>' . $oos_data . '%'
                    . '</br><b>' . 'ha' . ': </b>' . $ha_data . '%'
                    . ' </br><b>Show outlet details:</b> <a class="m--font-red red filter-submit margin-bottom" href="' . url('outlet/view/' . $outlet->id) . '  " data-toggle="tooltip" data-placement="top" title="Outlet details" target="_blank"><i class="fas fa-map-o"></i></a>';
...
//                }
        ...
        return view('report.numeric_distribution.dn_maps', $data);
    }
    ...
    function get_data_for_dn_maps_report(Request $request)
    {
        ...
        $res = $this->productRepository->get_data_for_dn_maps_report($data, $type);
        //dd($res);
        foreach ($res as $data) {
...
//                        . '<a class="btn btn-xs red filter-submit margin-bottom" href="' . site_url('outlets/view/' . $outlet->id) . ' " data-toggle="tooltip" data-placement="top" title="More details" target="_blank"><i class="icon-map"></i></a>';
        ...
        return view('report.shelf_share.shelf_share_maps', $data);
    }
    ...
    function stock_issue()
    {
        ...
        return view('report.stock_issue', $data);
    }
