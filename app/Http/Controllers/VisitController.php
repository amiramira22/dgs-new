...
class VisitController extends Controller {
    ...
    public function index(Request $request) {
        ...
        return view('visits.form_visit', $data);
    }
    ...
    function order_report($visit_id = false) {
        ...
        $data['visit'] = $visit;
        $data['id'] = $visit_id;
        $outlet_name = Outlet::find($visit->outlet_id)->name;
        $data['subTitle'] = "Order Report  | " . $outlet_name . " | " . reverse_format($visit->date);

        return view('visits.visit_order_report', $data);
    }
    ...
    public function create() {
        ...
        return view('visits.create', compact('title', 'subTitle'));
    }
    ...
    public function edit($id) {
        ...
        return view('visits.edit', compact('title', 'subTitle', 'visit', 'users', 'outlets'));
    }
    ...
    public function report($visit_id) {
        ...
        return view('visits.report', $data);
    }
    ...
    public function models($visit_id) {
        ...
        return view('visits.models', $data);
    }
...
//        $data['uniqueId'] = $visit->uniqueId;
    ...
    public function extrait_journalier(Request $request) {
        ...
        return view('visits.extrait_journalier', $data);
    }
    ...
    public function historique_pdv(Request $request) {
        ...
        return view('visits.historique_pdv', $data);
    }
    ...
    function position($visit_id, $type = 'all') {
        ...
        return view('visits.position', $data);
    }
    ...
    public function branding(Request $request) {
        ...
        return view('visits.branding', $data);
    }
    ...
    function trackingVisitsReport(Request $request) {
        ...
        return view('visits.tracking_visits_report', $data);
    }
