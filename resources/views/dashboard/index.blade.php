...
<link href="{{ asset('assets/amcharts/plugins/export/export.css') }}" rel="stylesheet" type="text/css"> -->
                                ...
                                <div class="m-widget24__item">
                                    ...
                                    <div class="progress m-progress--sm">
                                        <div class="progress-bar m--bg-info" role="progressbar"
                                             style="width: {{ $count_outlet }}%;" aria-valuenow="50" aria-valuemin="0"
                        ...
                        <a href="<?php echo url('dashboard/daily_details'); ?>" target="_blank">
                            ...
                            <div class="m-widget24">
                                <div class="m-widget24__item">
                                    ...
                                    <div class="progress m-progress--sm">
                                        <div class="progress-bar  m--bg-info" role="progressbar"
                                             style="width: <?php echo intval($daily); ?>%;" aria-valuenow="50"
                                ...
                                <div class="m-widget24__item">
                                    ...
                                    <div class="progress m-progress--sm">
                                        <div class="progress-bar  m--bg-danger" role="progressbar"
                                             style="width: <?php echo intval($monthly); ?>%;" aria-valuenow="50"
                                             aria-valuemin="0" aria-valuemax="100"></div>
                                    </div>
                                    <span class="m-widget24__change">
                                    ACHIVEMENT
        ...
        <div class="col-md-6">
            ...
            <div class="m-portlet m-portlet--full-height ">
                ...
                <div class="m-portlet__body">
                    <div class="m-scrollable m-scroller ps ps--active-y" data-scrollable="true" data-height="800"
                         data-mobile-height="800" style="height: 800px; ">
                        <?php
                        echo $maps['js'];
                        echo $maps['html'];
                        ?>
                                ...
                                <div class="m-widget3__header">
                                    ...
                                    <!--<img class="m-widget3__img" src="{{ asset('users/'.$image) }}" alt="">-->
                                        <img class="m-widget3__img"
                                             src="http://bcm.capesolution.tn/uploads/users/{{$image}}" alt="">
    ...
    <script type="text/javascript" language="javascript">
        $(document).ready(function () {
            ...
            $('#oos_peer_channel').html('<div class="col-md-12" align="center"><img width="120px" src="<?php
                echo asset('img/plus-loader.gif'); ?>" class="img-responsive img-center" /></div>');
            jQuery.ajax({
                type: 'post',
                data: {_token: CSRF_TOKEN},
                url: '<?= route('dashboard.load_oos_peer_channel') ?>',
            ...
            $('#oos_peer_category').html('<div class="col-md-12" align="center"><img width="120px" src="<?php
                echo asset('img/plus-loader.gif'); ?>" class="img-responsive img-center" /></div>');
            jQuery.ajax({
                type: 'post',
                data: {_token: CSRF_TOKEN},
                url: '<?= route('dashboard.load_oos_peer_category') ?>',
                success: function (data) {
                    $('#oos_peer_category').html(data);
                }
            });

            $('#top_5_oos').html('<div class="col-md-12" align="center"><img width="120px" src="<?php
                echo asset('img/plus-loader.gif'); ?>" class="img-responsive img-center" /></div>');
            jQuery.ajax({
                type: 'post',
                data: {_token: CSRF_TOKEN},
                url: '<?= route('dashboard.load_top_5_oos') ?>',
                success: function (data) {
                    $('#top_5_oos').html(data);
                }
            });
            ...
            $('#numeric_distribution').html('<div class="col-md-12" align="center"><img width="120px" src="<?php
                echo asset('img/plus-loader.gif'); ?>" class="img-responsive img-center" /></div>');
            jQuery.ajax({
                type: 'post',
                data: {_token: CSRF_TOKEN},
                url: '<?= route('dashboard.load_numeric_distribution') ?>',
                success: function (data) {
            ...
            $('#oos_trend').html('<div class="col-md-12" align="center"><img width="120px" src="<?php
                echo asset('img/plus-loader.gif'); ?>" class="img-responsive img-center" /></div>');
            jQuery.ajax({
                type: 'post',
                data: {_token: CSRF_TOKEN},
                url: '<?= route('dashboard.load_oos_trend') ?>',
                success: function (data) {
                    $('#oos_trend').html(data);
                }
            });
