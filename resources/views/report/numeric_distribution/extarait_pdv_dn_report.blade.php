...
@section('content')
    ...
    <div class="m-portlet m-portlet--tab">
        ...
        <!--begin::Form-->
        {!! Form::open(['url' => 'report/extarait_pdv_dn_report', 'method' => 'post', 'class' => 'm-form m-form--fit m-form--label-align-right','autocomplete'=>'off' ]) !!}
                    ...
                    <div class="table-responsive">
                        <table class="table table-bordered table-hover">
                         ...
                         {{--   <tr>
                                ...
                                <th> {{ App\Entities\Product::find($product_id)->code }} </th>
                                <?php } ?>
                            </tr>--}}
                            <tr>
                                <th></th>
            ...
            $(window).scroll(function () {
                ...
                if ((position == bottom) || ((position + 1) == bottom)) {
                    ...
                    if (row <= allcount) {
                        ...
                        $.ajax({
                            type: 'post',
                            url: '<?= route('report.load_extarait_pdv_dn_per_category') ?>',
                            data: {
                                _token: CSRF_TOKEN,
