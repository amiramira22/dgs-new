...
<div class="m-portlet m-portlet--tab">
    ...
    <div class="form-group m-form__group row">
        ...
        <label class="col-md-1 col-form-label">Field officer</label>
        <div class="col-md-3">
            {!! Form::select('fo_id', $fos , $fo_id ,['class' => 'form-control m-select2','id'=>'specific_fo']) !!}
        </div>

        <label class="col-md-1 col-form-label">Zones</label>
        <div class="col-md-3">
                        ...
                        <div class="carousel-inner">
                            ...
                            for ($i = 0; $i < $size_pictures; $i++) {
                                ...
                                <div class="carousel-item">
                                        ...
                                        <center>
                                            <img src="{{asset('uploads/branding/'.$one_pictures[$i])}}"
                                                 width="400px" height="400px" alt="admin-pic" download>
                                        </center>
