...
<div class="m-portlet m-portlet--tab">
    ...
    <!--begin::Form-->
    {!! Form::open(['url' => 'visit/branding', 'method' => 'post', 'class' => 'm-form m-form--fit m-form--label-align-right','autocomplete'=>'off' ]) !!}
    <div class="m-portlet__body">
        <div class="form-group m-form__group row">
            <label for="" class="col-lg-2 col-form-label">@lang('project.start_date')</label>
            ...
            <label for="" class="col-lg-2 col-form-label">@lang('project.end_date')</label>
            <div class="col-lg-4 col-md-9 col-sm-12">
                <div class="input-group date">
    ...
    <div class="m-portlet__body">
        <div class="form-group m-form__group row">
            ...
            <div class="col-lg-2 col-md-9 col-sm-12">
                @lang('project.MERCHANDISER')s {!! Form::select('fo_id', $fos , $fo_id ,['class' => 'form-control m-select2','id'=>'specific_fo']) !!}
            </div>
            <div class="col-lg-2 col-md-9 col-sm-12">
            ...
            <label class="col-lg-2 col-form-label"></label>
            <div class="col-lg-4 col-md-9 col-sm-12">
                @lang('project.OUTLET')s {!! Form::select('outlet_id', $outlets , null ,['class' => 'form-control m-select2','id'=>'specific_outlet']) !!}
            </div>
        </div>
    </div>
                        ...
                        <div class="carousel-inner">
                            <div class="carousel-item active">
                                ...
                                <table>
                                    <tr>
                                        <td width="5%"></td>
                                        <td width="100%">
                                            <img width="700px" height="350px" src="{{ asset('uploads/outlet/'. $row->outlet_picture) }}"  >
                            ...
                            <div class="carousel-item">
                                ...
                                <table>
                                        ...
                                        <tr>
                                            <td width="5%"></td>
                                            <td width="50%"><span><img src="{{ asset('uploads/branding/'. $branding_pictures[0][0]) }}" width="300px" height="350px" alt="admin-pic" download></span></td>
                                            <td width="5%"></td>
                                            <td width="50%"> <span><img src="{{ asset('uploads/branding/'. $branding_pictures[0][1]) }}" width="300px" height="350px" alt="admin-pic" download></span></td>
                                            <td width="5%"></td>
                                        </tr>
                            ...
                            for ($i = 1; $i < $size_pictures; $i++) {
                                ...
                                <div class="carousel-item">
                                    <table>
                                            ...
                                            <tr>
                                                <td width="5%"></td>
                                                <td width="50%"><span><img src="{{ asset('uploads/branding/'. $branding_pictures[$i][0]) }}" width="300px" height="350px" alt="admin-pic" download></span></td>
                                                <td width="5%"></td>
                                                <td width="50%"> <span><img src="{{ asset('uploads/branding/'. $branding_pictures[$i][1]) }}" width="300px" height="350px" alt="admin-pic" download></span></td>
                                                <td width="5%"></td>
                                            </tr>
